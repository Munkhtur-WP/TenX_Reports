<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="clrReport3.aspx.cs" Inherits="TENX_ADMIN.clrReport3" %>
					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Гүйлгээний тайлан</li>
							</ol>
						</nav>
					</div>
				</div>
		  ...
		  <div class="col-lg-12 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Гүйлгээний тайлан</h4>
			  </div>
