...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <!-- add buttons to this group -->
			  ...
			  <div class="col-md-12 col-lg-4">
				<div class="card">
					<div class="card-header d-flex justify-content-between">
						...
						<span class="text-muted"><small class="badge bg-primary"><i class="fa fa-clock-o"><% string postdate = (rw["CreatedDate"].ToString()); string strDate = postdate.ToString(); DateTime currentDate = DateTime.Now;  %><% DateTime loadedDate = DateTime.Parse(postdate);; %><%TimeSpan timegap = currentDate - loadedDate;%><% string message=""; message = string.Concat((timegap.Hours));%><%if (timegap.Days > 365)
    {
    ...
    {
        message = string.Concat(" ",timegap.Days, " өдрийн өмнө нийтлэгдсэн");
    }
    else if (timegap.Days == 1)
    {
